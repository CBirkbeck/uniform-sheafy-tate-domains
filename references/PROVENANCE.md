...
| `Fujiwara-Kato-Foundations-Rigid-Geometry-I.pdf` | <https://arxiv.org/pdf/1308.4734> | arXiv author manuscript |
...
| Huber, *A generalization of formal schemes and rigid analytic varieties* | Notations (``complete'' means complete and Hausdorff, p. 515); Proposition 1.3 (the universal property showing that the completed rational localisation depends only on the rational subset); Theorem 2.2 (the structure presheaf is a sheaf of complete topological rings, with rational acyclicity); Lemma 2.3 (finite-module maps are strict, and submodules are closed in the complete case); Lemma 2.4 (open mapping and strictness over a complete noetherian Tate ring). |
| Fujiwara--Kato, *Foundations of Rigid Geometry I* | Chapter 0, Section 7.1(c) (Hausdorff completion and its kernel, pp. 148--150 of the author manuscript); Chapter I, Section 1.4(b) (formal completion, pp. 267--268); Chapter II, Section 1.1(b) (the completed affine-chart description of admissible blow-ups for adic formal schemes of finite ideal type, pp. 433--435). |
| Kedlaya--Liu, *Relative \(p\)-adic Hodge theory: Foundations* | Remark 2.4.7 (small perturbations still generate the unit ideal and define the same rational subspace, p. 40 of the author manuscript). |
...
|---|---|---|
| AINTLIB formalisation | `CBirkbeck/AINTLIB`, finite-jet commit `b007a4f3d4226f00a684b402715aa542e2f0bcdc`, weighted-parity commit `090a289211deb69117413e329325fe819aa7dbc2`, sheaf-comparison commit `d92f96504f949ca43a27a817cb8d2f70b6486744`, and [abstract-base Scottish Book commit `01116aca6070283726008536cba16d165a01b505`](https://github.com/CBirkbeck/AINTLIB/commit/01116aca6070283726008536cba16d165a01b505), project `projects/AdicSpaces` | These are the immutable Git objects against which the paper's declaration crosswalk and axiom audit were run. The Paperforge site exposes the audited declarations from all four commits directly. |
...
| William Coram restricted-power-series code | Upstream repository <https://github.com/WilliamCoram/PhD/tree/e8fcf8fbff848a95475ab62ae2568cbb73961de8> (the last upstream commit before the 4 July 2026 vendoring), principally `PhD/PR'd/MvRestricted.lean`, `PhD/ToPR/MvGaussNorm.lean`, `PhD/ToPR/MvRestricted.lean`, and `PhD/ToPR/RestrictedIso.lean` | Adapted in AINTLIB as `Vendored/CoramMvRestricted.lean`, `CoramMvGaussNorm.lean`, `CoramMvRestrictedNorm.lean`, and `CoramRestrictedIso.lean`. The initial AINTLIB vendor commits are respectively `a6a128d567f26345d6653b9a8f275e024302a47c`, `5e4a87228793251a06a33966a446d7f46072fb1b`, `2322d3c045b68c3d42c4460d461ee31bcd9dd5fb`, and `8cdb21d5dbce2ab6c19ce015d33103c93dd460f2`. The upstream `LICENSE` and the vendored file headers specify Apache 2.0. |
| Fabrizio Barroero univariate Gauss-norm code | Pinned mathlib source <https://github.com/leanprover-community/mathlib4/blob/fd1d54bcac5caba4eff2ea3421c47d907333f515/Mathlib/RingTheory/PowerSeries/GaussNorm.lean>, originally introduced in [mathlib PR 24940](https://github.com/leanprover-community/mathlib4/pull/24940) | `Vendored/CoramRestrictedNorm.lean` imports this file and contains adapted wrappers staged in `PhD/ToPR/GaussNorm.lean`; Coram's later multivariable refactoring is recorded in [mathlib PR 38074](https://github.com/leanprover-community/mathlib4/pull/38074). These declarations occur in the finite-jet norm, domain, and uniformity proofs. |
| Bingyu Xia power-series equivalences | Xia's [mathlib PR 36507](https://github.com/leanprover-community/mathlib4/pull/36507), with exact initial source at `BryceT233/mathlib4` commit [`2fcf216`](https://github.com/BryceT233/mathlib4/blob/2fcf216bd57c6679cf8838bb4794590b4356994b/Mathlib/RingTheory/MvPowerSeries/Equiv.lean); the version vendored by AINTLIB was staged in `WilliamCoram/PhD` as `PhD/Bryce/Basic.lean` and `PhD/Bryce/Equiv.lean` | Combined and adapted in AINTLIB as `Vendored/XiaMvPowerSeriesEquiv.lean`, introduced by AINTLIB commit `a522ed904b5d238fefcec87a1592498533e828dc`. The vendored header attributes Bingyu Xia and specifies Apache 2.0. |
...
Barroero's mathlib Gauss-norm layer, and `XiaMvPowerSeriesEquiv`. The AINTLIB
copies at the audited commit, not the
