...
| Huber, *A generalization of formal schemes and rigid analytic varieties* | Proposition 1.3 (the universal property showing that the completed rational localisation depends only on the rational subset); Theorem 2.2 (the structure presheaf is a sheaf of complete topological rings, with rational acyclicity); Lemma 2.3 (finite-module maps are strict, and submodules are closed in the complete case); Lemma 2.4 (open mapping and strictness over a complete noetherian Tate ring). |
| Fujiwara--Kato, *Foundations of Rigid Geometry I* | Chapter II, Section 1.1(b) (the completed affine-chart description of admissible blow-ups for adic formal schemes of finite ideal type, pp. 433--435 of the author manuscript); Example 6.1.7(3) (rational subdomains as generic fibres of these affine charts, pp. 511--512). |
