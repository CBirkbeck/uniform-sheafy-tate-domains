...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="latex.preamble.early">
    ...
    <!-- Lean's source spelling is Unicode.  The primary draft uses listings'
         literate table; PreTeXt emits plain verbatim blocks, so its generated
         pdfLaTeX source needs the corresponding input declarations. -->
