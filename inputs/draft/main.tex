...
This article was prepared with the help of AI from an initial human-written
skeleton.  ChatGPT 5.6 Sol found both examples and supplied the proofs.  The
Lean formalisation was carried out by Claude Code.  We have aimed to cite related
...
After the rational localisation
$A\to A\langle W/\varpi\rangle$, $Q^2$ vanishes whereas $Q$ does not.
Thus the chart is non-reduced although $A$ is a domain.
...
in $a_i$.  In this case, for every $\ell\in L$, we could then write
\[
