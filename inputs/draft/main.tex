...
Ben-Bassat--Kremnizer prove the corresponding one-variable strict resolutions
for Weierstrass and Laurent localisations, and reduce a general rational
localisation to these cases \cite[Lemmas~5.13--5.14]{BBK}.  They do not
formulate a multivariable Koszul theorem.  That formulation, and the strict
Koszul regularity of rational localisations, is given by
Bambozzi--Kremnizer
...
Ben-Bassat--Kremnizer prove the one-variable strict two-term resolutions and
then factor a general rational localisation into Laurent and Weierstrass
localisations \cite[Lemmas~5.13--5.14]{BBK}; they do not state the
multivariable Koszul assertion.  Applied to $E\in\{B,C,D\}$, the strict
Koszul regularity theorem of
Bambozzi--Kremnizer
\cite[Notation~4.3, Definitions~4.5--4.6, Proposition~4.9,
