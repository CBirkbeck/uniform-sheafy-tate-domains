...
localisation is an integral domain.  Both constructions, including their
sheafiness and the rational localisations witnessing failure of stable
uniformity, have been formalised in Lean~4.
\end{abstract}
...
Both examples were found in collaboration with ChatGPT 5.6 Sol.  Their
construction, uniformity, sheafiness, and failure of stable uniformity
have been formalised in Lean~4.  The formalisation also includes the
rational-chart calculations used above.  \Cref{sec:formalisation}
records the relevant definitions and theorem statements.
