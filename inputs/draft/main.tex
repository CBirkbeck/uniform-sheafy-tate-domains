...
uses the class \texttt{IsSheafy}.  This is the form which is easiest to work
with in the calculations: it speaks directly about the completed rational
localisations which occur in the proofs.  The equivalences below show that,
for complete Tate pairs, it is the usual sheaf condition.  The class is in the
...
matching-family equaliser is also a topological embedding.  Together these
conditions give the concrete form of Wedhorn's sheaf condition for
topological rings.
...
\end{lstlisting}
Thus \texttt{IsSheafy} is retained because it is the convenient form for the
proofs, not because it defines a different notion of sheafiness.
