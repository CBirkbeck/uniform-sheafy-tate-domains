...
localisation is an integral domain.  These results are due to ChatGPT 5.6 Sol.
...
ChatGPT 5.6 Sol found both examples, supplied the proofs, and produced their
Lean formalisation.  We have aimed to cite related work that may have informed
this process; see \cref{rem:earlier-work}.  \Cref{sec:formalisation} records
the formal definitions and theorem statements.
