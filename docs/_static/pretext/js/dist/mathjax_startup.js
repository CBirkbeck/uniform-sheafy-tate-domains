let mathJaxOpts = {
  "tex": {
    "macros": {"toprule": "\\hline", "midrule": "\\hline", "bottomrule": "\\hline", "Spa": "\\operatorname{Spa}", "im": "\\operatorname{im}", "cO": "\\mathcal O", "onto": "\\twoheadrightarrow", "notn": ["\\class{ptxnotn-#1}{#2}", 2], "notnfar": ["\\class{ptxfar}{\\class{ptxnotn-#1}{#2}}", 2]},
    "inlineMath": [
      [
        "\\(",
        "\\)"
